...
export class ExploreComponent implements OnInit {
  ...
  rampRateDownAverage: number = 0;
  rampRateDownMedian: number = 0;
  rampRateDownExtreme: number = 0;

  rampRateUpAverage: number = 0;
  rampRateUpMedian: number = 0;
  rampRateUpExtreme: number = 0;
  ...
  onChangeDisplayMode(event: any): void {
    var mode = (event.target as HTMLOptionElement).value;
    this.log(mode);
